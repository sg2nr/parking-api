...
class AddFixedPricePolicyTest {
  ...
  public void setUp() {
    ...
    PricingPerHourPolicy basePolicy = new PricingPerHourPolicy(PRICE_PER_HOUR, currency);
    policy = new AddFixedPricePolicy(basePolicy, FIXED_PRICE, currency);
  }
  ...
  @Test
  public void testOneDayTotalAmount() throws TemporaryDataInconsistencyException {
    ZonedDateTime in = ZonedDateTime.now();
